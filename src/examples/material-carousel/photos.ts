...
// The same picsum seeds as the Apple Zoom example, so both demos browse one photo
// set. Copied rather than imported across example folders — every example stays
// self-contained so it can be dropped into another project as-is.
